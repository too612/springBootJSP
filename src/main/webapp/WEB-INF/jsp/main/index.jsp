...
%>
    ...
    <head>
      ...
      <!--====== Favicon Icon ======-->
      <link rel="shortcut icon" href="resources/assets/images/favicon.svg" type="image/svg" />
    ...
    <body>
          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <div class="ud-hero-image wow fadeInUp" data-wow-delay=".25s">
                ...
                <img src="resources/assets/images/hero/dotted-shape.svg" alt="shape" class="shape shape-1" />
                <img src="resources/assets/images/hero/dotted-shape.svg" alt="shape" class="shape shape-2" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="faq" class="ud-faq">
        <div class="shape">
          <img src="resources/assets/images/faq/shape.svg" alt="shape" />
        </div>
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
          ...
          <div class="row">
              ...
              <div class="ud-single-testimonial wow fadeInUp" data-wow-delay=".1s">
                ...
                <div class="ud-testimonial-info">
                  <div class="ud-testimonial-image">
                    <img src="resources/assets/images/testimonials/author-01.png" alt="author" />
                  </div>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="ud-single-testimonial wow fadeInUp" data-wow-delay=".15s">
                ...
                <div class="ud-testimonial-info">
                  <div class="ud-testimonial-image">
                    <img src="resources/assets/images/testimonials/author-02.png" alt="author" />
                  </div>
                  <div class="ud-testimonial-meta">
                    <h4>Margin Gesmu</h4>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="ud-single-testimonial wow fadeInUp" data-wow-delay=".2s">
                ...
                <div class="ud-testimonial-info">
                  <div class="ud-testimonial-image">
                    <img src="resources/assets/images/testimonials/author-03.png" alt="author" />
                  </div>
                  <div class="ud-testimonial-meta">
                    <h4>William Smith</h4>
            ...
            <div class="col-lg-12">
              <div class="ud-brands wow fadeInUp" data-wow-delay=".2s">
                ...
                <div class="ud-brands-logo">
                  ...
                  <div class="ud-single-logo">
                    <img src="resources/assets/images/brands/graygrids.svg" alt="graygrids" />
                  </div>
                  <div class="ud-single-logo">
                    <img src="resources/assets/images/brands/lineicons.svg" alt="lineicons" />
                  </div>
                  <div class="ud-single-logo">
                    <img src="resources/assets/images/brands/ecommerce-html.svg" alt="ecommerce-html" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-3 col-sm-6">
              <div class="ud-single-team wow fadeInUp" data-wow-delay=".1s">
                <div class="ud-team-image-wrapper">
                  ...
                  <img src="resources/assets/images/team/dotted-shape.svg" alt="shape" class="shape shape-1" />
                  <img src="resources/assets/images/team/shape-2.svg" alt="shape" class="shape shape-2" />
                </div>
                  ...
                  <ul class="ud-widget-brands">
                    <li>
                      <a href="https://ayroui.com/" rel="nofollow noopner" target="_blank">
                        <img src="resources/assets/images/footer/brands/ayroui.svg" alt="ayroui" />
                      </a>
                    </li>
                    <li>
                      <a href="https://ecommercehtml.com/" rel="nofollow noopner" target="_blank">
                        <img src="resources/assets/images/footer/brands/ecommerce-html.svg" alt="ecommerce-html" />
                      </a>
                    </li>
                    <li>
                      <a href="https://graygrids.com/" rel="nofollow noopner" target="_blank">
                        <img src="resources/assets/images/footer/brands/graygrids.svg" alt="graygrids" />
                      </a>
                    </li>
                    <li>
                      <a href="https://lineicons.com/" rel="nofollow noopner" target="_blank">
                        <img src="resources/assets/images/footer/brands/lineicons.svg" alt="lineicons" />
                      </a>
                    </li>
                    <li>
                      <a href="https://uideck.com/" rel="nofollow noopner" target="_blank">
                        <img src="resources/assets/images/footer/brands/uideck.svg" alt="uideck" />
                      </a>
                    </li>
                    <li>
                      <a href="https://tailwindtemplates.co/" rel="nofollow noopner" target="_blank">
                        <img src="resources/assets/images/footer/brands/tailwindtemplates.svg"
